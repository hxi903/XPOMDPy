...
the belief.
Limitation: This parser is not suitable for large number of states. In such case, you may convvert your POMDP into POMDPX file and use the POMDPX parser. 
Original author: mbforbes https://github.com/mbforbes/py-pomdp
